...
public class RPCThreadSharedContext {
  ...
  private static final Map<String, CompletableFuture<RPCResponse>> RESPONSES_MAP =
      new ConcurrentHashMap<>();
  private static final Map<String, ServiceConfig<?>> HANDLERS_MAP = new ConcurrentHashMap<>();

  public static void registerResponseFuture(
      String requestId, CompletableFuture<RPCResponse> responseCompletableFuture) {
