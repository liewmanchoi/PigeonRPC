...
//     * @param appKey 服务唯一标识
//     * @return javafx.util.Pair<java.util.List <
// com.liewmanchoi.pigeon.rpc.protocol.ProviderService>,java.util
//     * .List<com.liewmanchoi.pigeon.rpc.protocol.InvokerService>>
//     * @date 2019/6/23
//     */
//    Pair<List<ProviderInfo>, List<InvokerInfo>> queryProvidersAndInvokers(String serviceName,
// String appKey);
// }
