...
import com.liewmanchoi.pigeon.rpc.transport.pigeon.client.ClientMessageHandler;
            ...
            protected void initChannel(Channel ch) throws Exception {
                ch.pipeline()
                        ...
                        .addLast("IdleStateHandler",
                                new IdleStateHandler(PigeonConstant.HEART_BEAT_TIME_OUT_MAX_TIME * PigeonConstant.HEART_BEAT_TIME_OUT, 0, 0))
                        // 出站：添加长度length域
